...
__doc__ = """Файл содержит функции, связанные с реестром, для создания, перечисления, редактирования и удаления Windows.
ключи и значения реестра. перечисления и словари с целыми числами, связанными с реестром, импортированные из модуля winreg
Также предоставляется вспомогательная функция is_x64os. 
"""
